...
修改 [!UICONTROL 瀏覽] 和前幾節的目標量度，以及您應針對 [!UICONTROL 自動鎖定目標] 報表面板是建立轉換率，這些轉換率是目標量度與適當篩選的適當歸因的正確比率 [!UICONTROL 瀏覽] 量度。
...
*圖8:最終的A4T [!UICONTROL 自動鎖定目標] 報告 [!DNL Adobe Analytics] [!DNL Workspace]，結合本教學課程前幾節所述對量度定義的所有調整。*
