...
>[!NOTE]
>
>目前，[!UICONTROL Auto-Target]的A4T報告的[!UICONTROL Control vs Targeted]個維度無法使用[!UICONTROL Lift and Confidence]個數字。 在新增支援之前，可藉由下載[可信度計算器](https://experienceleague.adobe.com/docs/target/assets/complete_confidence_calculator.xlsx)來手動計算[!UICONTROL Lift and Confidence]。
...
當量度是[!DNL Target]轉換，或具有&#x200B;**每次造訪量度值最大化**&#x200B;的[!DNL Analytics]量度時，目標量度定義允許在同一次造訪中發生多個轉換事件。
...
### 具有&#x200B;*不重複造訪轉換率*&#x200B;的[!DNL Analytics]量度
