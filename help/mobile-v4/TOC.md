---
user-guide-title: Adobe Target搭配Android適用的Adobe Mobile Services SDK v4
...
+ [概觀](https://experienceleague.adobe.com/docs/target-learn/tutorials/overview.html)
+ [下載並更新範例應用程式](download-and-update-the-sample-app.md)
+ [新增請求](add-requests.md)
+ [新增引數](add-parameters.md)
+ [建立對象和選件](create-audiences-and-offers.md)
