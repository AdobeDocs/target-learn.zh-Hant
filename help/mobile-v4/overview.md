...
如果您沒有存取Experience Cloud解決方案所需的許可權，請聯絡您的Experience Cloud管理員。
...
1. 您應該會前往Adobe Target中的「活動」清單（如下圖所示），且您應該會看到使用者擁有核准者層級的存取權。 如果您無法存取[!DNL Target]或無法驗證核准者層級的存取權，請聯絡貴公司的其中一個Experience Cloud管理員，要求此存取權，並在授與教學課程後繼續進行：
