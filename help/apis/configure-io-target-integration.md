...
恭喜！ 現在您已驗證了Adobe驗證，您可以使用它與Adobe TargetAPI(以及其他AdobeAPI)進行交互。 例如， [使用RecommendationsAPI](https://experienceleague.adobe.com/docs/target-learn/recommendations-api-tutorial/recs-api-overview.html) 建立或管理建議。
