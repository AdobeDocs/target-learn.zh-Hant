...
+ [使用包含Recommendations的傳送API](https://experienceleague.adobe.com/docs/target-dev/developer/api/recommendations-api/fetch-recs-server-side-delivery-api.html?lang=zh-Hant){target="_blank"}
